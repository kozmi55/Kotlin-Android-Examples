...
class GetUsersTest {
    ...
    fun testExecute_userListModelWithOneItem_emitListWithOneViewModel() {
        ...
        testObserver.assertValue { UserViewDatas: List<UserViewData> -> UserViewDatas.size == 1 }
        testObserver.assertValue { UserViewDatas: List<UserViewData> ->
            UserViewDatas.get(0) == UserViewData(1, "Name", 100, "Image url") }
    }
    ...
    fun testExecute_userListModelEmpty_emitEmptyList() {
        ...
        testObserver.assertNoErrors()
        testObserver.assertValue { UserViewDatas: List<UserViewData> -> UserViewDatas.isEmpty() }
    }
}